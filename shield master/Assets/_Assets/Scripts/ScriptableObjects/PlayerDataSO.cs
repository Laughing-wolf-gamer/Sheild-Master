...
namespace SheildMaster{
    ...
    public class PlayerDataSO : ScriptableObject {
        ...
        public void ClearData(){
            ...
            playerSaveData.dimondAmount = 0;
            playerSaveData.maxCoinCount = 0;
            playerSaveData.isClaimed_5_Times = false;
            playerSaveData.isClamedDailyBonus = false;
            playerSaveData.HasAdsInGame = true;
            playerSaveData.currentDay = 0;
            playerSaveData.lostSceneIndex = -1;
            playerSaveData.totalKillCounts = 0;
            playerSaveData.lostData.spawnPointlist = new List<Vector3>();
            Save();
        }
